...
final_model.save(r"E:\模型10\ha_maccs_chem_regularized.keras")
...
plt.savefig(r'E:\模型10\ha_maccs_chem_ROC_regularized.pdf', dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig(r'E:\模型10\ha_maccs_chem_training_history_regularized.pdf', dpi=300, bbox_inches='tight')
plt.close()
