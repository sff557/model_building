...
# ==================== 数据加载 ====================
df_x_train = pd.read_csv(r"E:\训练集测试集2/hy合X_train.csv", na_values=["?", "NA"])
df_y_train = pd.read_csv(r"E:\训练集测试集2/hy合y_train.csv", na_values=["?", "NA"])
df_x_test = pd.read_csv(r"E:\训练集测试集2/hy合X_test.csv", na_values=["?", "NA"])
df_y_test = pd.read_csv(r"E:\训练集测试集2/hy合y_test.csv", na_values=["?", "NA"])
...
final_model.save(r"E:\模型10\hy_maccs_chem_regularized.keras")
...
plt.savefig(r'E:\模型10\hy_maccs_chem_ROC_regularized.pdf', dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig(r'E:\模型10\hy_maccs_chem_training_history_regularized.pdf', dpi=300, bbox_inches='tight')
plt.close()
