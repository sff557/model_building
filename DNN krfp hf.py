...
df_x_train = pd.read_csv(r"E:\训练集测试集5\hfX_train_krfp.csv")
df_y_train = pd.read_csv(r"E:\训练集测试集5\hfy_train_krfp.csv")
df_x_test = pd.read_csv(r"E:\训练集测试集5\hfX_test_krfp.csv")
df_y_test = pd.read_csv(r"E:\训练集测试集5\hfy_test_krfp.csv")
...
# 保存模型和scaler
final_model.save(r"E:\模型9\hf_model_best.keras")
import joblib

joblib.dump(scaler, r"E:\模型9\hf_scaler_best.pkl")
print("模型和scaler已保存")
...
plt.savefig('E:/模型9/hf_ROC_best.pdf', dpi=300, bbox_inches='tight')
plt.close()
...
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('E:/模型9/hf_training_best.pdf', dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('E:/模型9/hf_confusion_best.pdf', dpi=300, bbox_inches='tight')
plt.close()
