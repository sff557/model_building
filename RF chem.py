...
# 定义保存目录 - 修改为RF专用目录
SAVE_DIR = r"E:\RF_chem_Results"  # 修改这里为您想要的路径
...
# 读取数据
df_x_train = pd.read_csv(r"E:\训练集测试集\arX_train_chemberta.csv", na_values=["?", "NA", " ", ""])
df_y_train = pd.read_csv(r"E:\训练集测试集\ary_train_chemberta.csv", na_values=["?", "NA", " ", ""])
df_x_test = pd.read_csv(r"E:\训练集测试集\arX_test_chemberta.csv", na_values=["?", "NA", " ", ""])
df_y_test = pd.read_csv(r"E:\训练集测试集\ary_test_chemberta.csv", na_values=["?", "NA", " ", ""])
...
# 保存数据预处理器
imputer_save_path = os.path.join(SAVE_DIR, "ar_rf_imputer.pkl")
...
# 保存ROC曲线
roc_save_path = os.path.join(SAVE_DIR, 'ar_rf_ROC.pdf')
...
# 保存模型
model_save_path = os.path.join(SAVE_DIR, "ar_rf_model.pkl")
joblib.dump(best_model, model_save_path)

# 保存预测结果
y_test_save_path = os.path.join(SAVE_DIR, "y_test_model_ar_rf.npy")
y_pred_save_path = os.path.join(SAVE_DIR, "y_pred_model_ar_rf.npy")
...
results_save_path = os.path.join(SAVE_DIR, 'ar_rf_results.csv')
...
fold_results_save_path = os.path.join(SAVE_DIR, 'ar_rf_cv_fold_results.csv')
